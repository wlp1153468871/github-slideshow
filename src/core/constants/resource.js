...
export const RESOURCE = {
  ...
  DEPLOYMENT_CONFIG: {
    ...
    route: { name: 'resource.deploymentconfigs.list' },
    hidden: true,
  },
  STATEFUL_SET: {
    key: 'stateful-set',
