<template>
  <div id="zone">
    ...
    <div class="table">
      ...
      >
        <el-table-column label="可用区名称" prop="name" width="250" style="color: #217EF2"></el-table-column>
        <el-table-column label="集群地址" prop="clusterUrl" width="250"></el-table-column>
...
<style lang="scss" src="./zone.scss" scoped></style>
