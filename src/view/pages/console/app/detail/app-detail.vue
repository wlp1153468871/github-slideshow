<template>
  <div class="app-detail-yaml">
    ...
    <div v-else>
      <resource-header :resource="resource">
        <template #action-buttons>
          <div class="header-btn-group">
            <save-button
              v-if="$can('serviceInstance.update')"
              :saving="loadings.updateByYaml"
              @click="toggleYamlDialog"
              text="编辑 YAML"
            ></save-button>
            <button class="dao-btn white" @click="loadApplicationInstance">
              <svg class="icon">
      ...
      <el-tabs class="daox-tabs-control" v-model="activeTab" @tab-click="switchTab">
        <!-- 预览 -->
        ...
        <el-tab-pane :label="TABS.JOB" :name="TABS.JOB">
          <job-panel :jobs="events"> </job-panel>
        </el-tab-pane>
        ...
        <el-tab-pane
          ...
          name="TABS.PARAMETER"
        >
          <parameter-panel :instance="instance"> </parameter-panel>
        </el-tab-pane>
      </el-tabs>
    </div>
