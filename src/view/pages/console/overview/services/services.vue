  ...
  <div class="page-service-overview">
    ...
    <div class="overview-content">
      ...
      <div class="service-list">
        <div
          :class="layoutType"
          v-if="serviceAvailable && availableServices.length">
          <div
            class="service-cell"
            ...
            <div class="box-wrap" @click="gotoInstanceList(service)">
              ...
              <logo-placeholder class="logo-box" v-if="!service.logo_url">
              </logo-placeholder>
            ...
            <div class="create-btn" v-if="$can('create')">
              <dao-tooltip
                content="可用区正在同步，服务无法创建"
                v-if="isZoneSyncing">
                <button
                  class="dao-btn blue"
                  @click="deployService(service)"
                  :disabled="isZoneSyncing || isDeleted(service)">创建服务
                </button>
              </dao-tooltip>
              <button
                v-else
