          ...
          <div class="dao-setting-section">
            <div class="dao-setting-item">
              ...
              <div class="dao-setting-content">
                <dao-switch name="enabled" v-model="config.is_need_approval" :with-notice="true">
                </dao-switch>
              </div>
            </div>
          </div>
              ...
              <div class="dao-setting-content">
                ...
                >
                  <div class="dao-table-toolbar">
                    <div class="dao-btn has-icon blue" @click="showAddUserDialog()">
                  ...
                  <div class="dao-table-main">
                    <table class="dao-table row">
                      ...
                      <tbody>
                        <tr v-for="user in approverList" :key="user.phone_number">
                          <td>{{ user.username }}</td>
                    ...
                    <empty-state v-show="!approverList.length" title="审批成员为空"> </empty-state>
                  </div>
                </div>
              </div>
            </div>
            <div class="dao-setting-mark" :class="{ open: !config.is_need_approval }"></div>
          </div>

          <div class="dao-setting-layout-footer">
            <button class="dao-btn blue" @click="save()">
              保存
            </button>
          </div>
        </div>
