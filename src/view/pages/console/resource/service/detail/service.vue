    ...
    <template v-else>
      ...
      <el-tabs v-model="activeTab">
        <el-tab-pane :label="TABS.OVERVIEW.label" :name="TABS.OVERVIEW.name">
          <service-overview-panel :service="service" :ingresses="ingresses" :routes="routes">
          </service-overview-panel>
        </el-tab-pane>

        <el-tab-pane :label="TABS.POD.label" :name="TABS.POD.name">
          <pod-table
        ...
        <el-tab-pane :label="TABS.EVENT.label" :name="TABS.EVENT.name">
          <events-table v-if="activeTab === TABS.EVENT.name" :events="events"> </events-table>
        </el-tab-pane>
      </el-tabs>
    </template>

    <edit-yaml-dialog :value="service" :visible.sync="dialogs.update" @update="updateService">
    </edit-yaml-dialog>
  </div>
</template>
...
<style src="./_service.scss" lang="scss"></style>
