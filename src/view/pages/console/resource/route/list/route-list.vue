    ...
    <template v-if="!loadings.page">
      ...
      <div class="dao-view-main">
        <div class="dao-view-content">
          ...
          <el-table v-loading="loadings.table" :data="routesInCurrentPage">
            <el-table-column :label="'name' | translate" sortable :sort-method="sortName">
              <template slot-scope="{ row: route }">
                <el-table-name-cell :resource="route" routerName="resource.routes.detail">
                </el-table-name-cell>
                <route-warnings
