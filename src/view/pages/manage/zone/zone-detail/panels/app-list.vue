              ...
              <span class="dao-btn-group">
                ...
                >
                  ...
                  <dao-dropdown-menu slot="list" style="min-width: 120px;">
                    ...
                    <dao-dropdown-item style="margin-left: 10px" @click="handleClick(scope.row.id, scope.row.zoneId)">
  ...
  export default {
    ...
    methods: {
      ...
      handleClick(id, zoneId) {
        console.log('删除应用');
        ZoneAdminService.deleteApplication(id, zoneId).then(res => {
          this.getSelectZone();
        })
      },
    }
