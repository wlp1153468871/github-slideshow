...
<script>
import { max, find, cloneDeep, get as getValue } from 'lodash';
...
export default {
  ...
  methods: {
    ...
    loadQuotaGroups() {
      QuotaService.listOrgQuotaGroups(this.orgId).then(groups => {
