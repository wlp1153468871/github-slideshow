  ...
  <nav class="g-nav" :class="{ invisible: isFullscreened }">
    ...
    <div class="nav-right-container">
      <template v-if="!zoneUnauthorized">
        ...
        >
          <div class="common-topbar-nav">
            <ul v-if="headerMenus.length" class="common-topbar-nav-list">
              <li
          ...
          >
            ...
            >
              ...
              <div class="block-right" ref="blockRight">
                <template v-for="(item, index) in selectedServices">
                  <div
                  ...
                  >
                    ...
                    <template v-if="item.isDefault">
                      <div class="operation-line">
                        ...
                        <p class="operation-link disabled" v-else>
                          创建{{ item.name | translate }}
                        </p>
                    ...
                    <div class="operation-line" v-if="item.help_url">
                      <a :href="item.help_url" target="_blank">查看帮助信息</a>
                    </div>
                  </div>
                </template>
              </div>
          ...
          >
            ...
            <el-option-group v-for="group in options" :key="group.label" :label="group.label">
              ...
              >
                ...
                <span class="instance-create-time" v-if="group.label === '实例'">
      ...
      <div class="user-operation">
        <dao-dropdown trigger="click" :append-to-body="false" placement="bottom-end">
...
<script src="./_global-nav-bar.js"></script>

<style src="./_global-nav-bar.scss" lang="scss"></style>
